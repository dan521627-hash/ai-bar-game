...
BUILTIN_GUESTS: List[Dict[str, Any]] = [{'id': 'li_bai',
  'name': '李白',
 ...
 {'id': 'mulan_legend',
  ...
  'budget': 47,
  'rarity': 'uncommon',
  'temperament': '安静、坚韧，不喜欢别人替她决定该成为什么',
  'ethos': 'duty'},
 {'id': 'alien_beekeeper',
  'name': '外星养蜂人',
  'origin': '蜂巢行星N-4·硅基旅人',
  'likes': ['sweet', 'floral', 'sour'],
  'dislikes': ['smoky'],
  'budget': 60,
  'rarity': 'uncommon',
  'temperament': '耐心、温柔，随身蜂群会对谎言发出蓝光',
  'ethos': 'hive'},
 {'id': 'harry_potter_adult',
  'name': '成年后的哈利·波特',
  'origin': '魔法世界·现代虚构来客',
  'temperament': '疲惫但仍愿意保护别人，不喜欢被当成符号',
  'ethos': 'courage',
  'budget': 58,
  'rarity': 'rare',
 ...
 {'id': 'naruto_adult',
  'name': '成年后的漩涡鸣人',
  'origin': '忍者世界·动画虚构来客',
  'temperament': '外向、坚韧，仍记得被整个村子排斥的滋味',
  'ethos': 'bond',
  'budget': 49,
  'rarity': 'rare',
 ...
 {'id': 'tony_stark',
  'name': '托尼·斯塔克',
  'origin': '漫威宇宙·影视漫画来客',
  'temperament': '锋利、爱炫耀，恐惧常被他包装成笑话和技术',
 ...
 {'id': 'zhongli',
  'name': '钟离',
  'origin': '提瓦特·游戏来客',
  'temperament': '从容、博闻，亲历契约与时代退场，常常忘记普通人的支付习惯',
  'ethos': 'contract',
  'budget': 88,
  'rarity': 'rare',
  'likes': ['woody', 'rich', 'floral'],
  'dislikes': ['sweet']},
 {'id': 'zhang_chulan',
  'name': '张楚岚',
  'origin': '异人江湖·国漫来客',
  'temperament': '看似圆滑怕事，实际极会隐忍和判断局势，不愿让别人轻易看清真正底牌',
  'ethos': 'survival',
  'budget': 47,
  'rarity': 'uncommon',
  'likes': ['floral', 'sweet', 'herbal'],
 ...
 {'id': 'frieren',
  'name': '芙莉莲',
  'origin': '勇者旅程之后·日漫来客',
  'temperament': '安静、长寿，对人类时间曾经迟钝，后来开始认真收集短暂关系留下的细节',
  'ethos': 'memory',
  'budget': 62,
  'rarity': 'rare',
  'likes': ['floral', 'sweet', 'herbal'],
